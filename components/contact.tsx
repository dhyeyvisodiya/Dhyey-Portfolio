...
export function Contact() {
  ...
  const socialLinks = [
    ...
    { icon: Mail, href: "mailto:dhyey@example.com?subject=Portfolio Inquiry&body=Hi Dhyey,", label: "Mail" },
  ]
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <Button
                    ...
                    variant="outline"
                    size="icon"
                    className="border-gray-600 text-gray-300 hover:bg-gray-700 bg-transparent hover:border-red-500 transition-all duration-300 hover:scale-110"
                    asChild
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Input
                      ...
                      className="bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus:border-red-500 transition-colors"
                      required
                    />
                  </div>
                  <div>
                ...
                <div>
                  <Input
                    ...
                    onChange={handleChange}
                    className="bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus:border-purple-500 transition-colors"
                    required
                  />
                </div>
                <div>
